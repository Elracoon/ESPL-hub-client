...
const CardProject : FC<CardProjectProps> = ( props ) => {
    ...
    return (
        <div className="w-[31%] h-auto bg-background border-2 rounded-lg p-6 text-xl text-white font-medium">
            ...
            <p className="text-muted-foreground font-light text-base">Projet crée par <span className="text-white hover:underline hover:cursor-pointer">{ props.owner }</span> le <span className="text-white">{ props.date }</span></p>
