    ...
    return (
        <TabsContent value="projets" className="tabs-content-dashboard">
            <div className="w-full h-auto pt-2 pb-10 text-2xl flex-col-start-start gap-4 font-semibold">
                <h1 className="text-7xl">Projets</h1>
                <p className="font-normal text-muted-foreground">Consultez les derniers projets publiés et commencez dès maintenant à répondre à des offres</p>
            </div>
